    ...
    constructor(options) {
        ...
        this.server = (0, node_http_1.createServer)(async (req, res) => {
            ...
            try {
                ...
                const { handler, paramsSchema, querySchema, bodySchema, keepConnectionAlive, skipBodyParsing, } = routeDefinition;
                ...
                const body = skipBodyParsing ? undefined : await (0, http_js_1.getJsonBody)(req);
