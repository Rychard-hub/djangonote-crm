import type { MachinePresetName, QueueTypeName, RunStatus, WaitpointTokenStatus } from "../schemas/index.js";
...
export type CreateBulkActionOptions = (BaseBulkActionOptions & {
    action: "cancel";
    targetRegion?: never;
