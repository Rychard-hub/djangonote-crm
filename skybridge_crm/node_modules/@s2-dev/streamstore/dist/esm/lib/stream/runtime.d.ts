 ...
 */
export type Runtime = "node" | "browser" | "deno" | "bun" | "workerd" | "unknown";
/**
 ...
 */
export declare function supportsHttp2(): boolean;
/**
 ...
 */
export declare function canSetUserAgentHeader(runtime?: Runtime): boolean;
/**
 ...
 */
export { VERSION };
export declare const DEFAULT_USER_AGENT = "s2-sdk-typescript/0.22.10";
