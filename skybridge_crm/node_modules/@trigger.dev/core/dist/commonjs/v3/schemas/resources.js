...
exports.ImageDetailsMetadata = exports.BackgroundWorkerMetadata = exports.PromptResource = exports.BackgroundWorkerSourceFileMetadata = exports.TaskResource = exports.AgentConfig = void 0;
const zod_1 = require("zod");
const schemas_js_1 = require("./schemas.js");
const common_js_1 = require("./common.js");
exports.AgentConfig = zod_1.z.object({
    type: zod_1.z.string(), // "ai-sdk-chat" initially, extensible for future agent types
});
exports.TaskResource = zod_1.z.object({
    ...
    agentConfig: exports.AgentConfig.optional(),
...
exports.PromptResource = zod_1.z.object({
    id: zod_1.z.string(),
    description: zod_1.z.string().optional(),
    filePath: zod_1.z.string(),
    exportName: zod_1.z.string().optional(),
...
exports.BackgroundWorkerMetadata = zod_1.z.object({
    ...
    prompts: zod_1.z.array(exports.PromptResource).optional(),
