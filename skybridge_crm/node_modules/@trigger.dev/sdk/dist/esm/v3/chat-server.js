...
import { convertToModelMessages, generateId as generateAssistantMessageId, stepCountIs, } from "../imports/ai-runtime.js";
// ---------------------------------------------------------------------------
// Public API
// ---------------------------------------------------------------------------
export const chat = {
    ...
    headStart(opts) {
        ...
        if (apiClient) {
            return async (req) => apiClientManager.runWithConfig(apiClient, () => handler(req));
        }
        return handler;
    },
    /**
