...
exports.EventRuleSchema = exports.EventFilterSchema = exports.stringPatternMatchers = void 0;
...
const EventMatcherSchema = zod_1.z.union([
...
exports.EventFilterSchema = zod_1.z.lazy(() => zod_1.z.record(zod_1.z.union([EventMatcherSchema, exports.EventFilterSchema])));
exports.EventRuleSchema = zod_1.z.object({
    event: zod_1.z.string().or(zod_1.z.array(zod_1.z.string())),
    source: zod_1.z.string(),
    payload: exports.EventFilterSchema.optional(),
    context: exports.EventFilterSchema.optional(),
});
