    ...
    async initializeServerStream() {
        try {
            ...
            if (lastAcked?.end) {
                ...
                this.log(`[S2MetadataStream] Written ${this.lastSeqNum} records, ending at seqNum=${this.lastSeqNum}`);
            }
        }
        catch (error) {
            if (this.aborted) {
...
function extractChunkType(chunk) {
 ...
 */
export function encodeChunkOrError(chunk) {
