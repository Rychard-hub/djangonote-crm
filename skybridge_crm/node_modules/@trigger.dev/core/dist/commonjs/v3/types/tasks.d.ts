...
import type { AnyOnCatchErrorHookFunction, OnCatchErrorHookFunction, OnCleanupHookFunction, OnCompleteHookFunction, OnFailureHookFunction, OnInitHookFunction, OnMiddlewareHookFunction, OnResumeHookFunction, OnStartHookFunction, OnSuccessHookFunction, OnWaitHookFunction, OnCancelHookFunction, OnStartAttemptHookFunction } from "../lifecycleHooks/types.js";
import type { RunTags } from "../schemas/api.js";
import type { MachineCpu, MachineMemory, MachinePresetName, RetryOptions, PromptMetadata, TaskMetadata, TaskRunContext } from "../schemas/index.js";
...
export interface Task<TIdentifier extends string, TInput = void, TOutput = any> {
     ...
     * ```
     */
    triggerAndSubscribe: (payload: TInput, options?: TriggerAndSubscribeOptions) => TaskRunPromise<TIdentifier, TOutput>;
    /**
