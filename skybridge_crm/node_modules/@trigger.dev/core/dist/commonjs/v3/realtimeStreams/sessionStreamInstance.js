...
exports.SessionStreamInstance = void 0;
...
class SessionStreamInstance {
    ...
    async initializeWriter() {
        ...
        return new streamsWriterV2_js_1.StreamsWriterV2({
            basin,
            stream: streamName,
            accessToken,
            endpoint,
...
exports.SessionStreamInstance = SessionStreamInstance;
