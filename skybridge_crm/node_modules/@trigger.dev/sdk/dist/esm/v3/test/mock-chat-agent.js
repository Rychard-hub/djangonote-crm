...
import { __setReadChatSnapshotImplForTests, __setReplaySessionInTailImplForTests, __setReplaySessionOutTailImplForTests, __setWriteChatSnapshotImplForTests, } from "../ai.js";
import { createTestSessionHandle } from "./test-session-handle.js";
 ...
 * ```
 */
export function mockChatAgent(agent, options = {}) {
    ...
    __setReadChatSnapshotImplForTests((_id) => {
    ...
    __setSessionOpenImplForTests((id) => createTestSessionHandle(id, sessionOutState, () => runSignal?.signal));
