import type { AnyOnInitHookFunction, AnyOnStartHookFunction, LifecycleHooksManager, RegisteredHookFunction, RegisterHookFunctionParams, AnyOnFailureHookFunction, AnyOnSuccessHookFunction, AnyOnCompleteHookFunction, AnyOnWaitHookFunction, AnyOnResumeHookFunction, AnyOnCatchErrorHookFunction, AnyOnMiddlewareHookFunction, AnyOnCleanupHookFunction, TaskWait, AnyOnCancelHookFunction, AnyOnStartAttemptHookFunction } from "./types.js";
export declare class StandardLifecycleHooksManager implements LifecycleHooksManager {
    ...
    private globalStartAttemptHooks;
    private taskStartAttemptHooks;
