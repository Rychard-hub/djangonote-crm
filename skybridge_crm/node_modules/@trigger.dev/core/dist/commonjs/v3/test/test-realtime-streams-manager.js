...
exports.TestRealtimeStreamsManager = void 0;
const asyncIterableStream_js_1 = require("../streams/asyncIterableStream.js");
class TestRealtimeStreamsManager {
    buffers = new Map();
    pipeWaits = new Map();
    ...
    pipe(key, source, _options) {
        ...
        const wrappedStream = (0, asyncIterableStream_js_1.createAsyncIterableStreamFromAsyncIterable)(replayStream);
...
exports.TestRealtimeStreamsManager = TestRealtimeStreamsManager;
