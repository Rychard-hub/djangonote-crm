...
import { SSEStreamSubscription, SSEStreamSubscriptionFactory, runShapeStream, } from "./runStream.js";
...
export class ApiClient {
    ...
    createUploadPayloadUrl(filename, requestOptions) {
        ...
        return zodfetch(CreateUploadPayloadUrlResponseBody, `${this.baseUrl}/api/v2/packets/${encoded}`, {
            method: "PUT",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    getPayloadUrl(filename, requestOptions) {
        const encoded = encodeURIComponent(filename);
        return zodfetch(CreateUploadPayloadUrlResponseBody, `${this.baseUrl}/api/v1/packets/${encoded}`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    ...
    createChatSnapshotUploadUrl(sessionId, requestOptions) {
        return zodfetch(CreateUploadPayloadUrlResponseBody, `${this.baseUrl}/api/v1/sessions/${encodeURIComponent(sessionId)}/snapshot-url`, {
            method: "PUT",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    ...
    retrieveSpan(runId, spanId, requestOptions) {
        return zodfetch(RetrieveSpanDetailResponseBody, `${this.baseUrl}/api/v1/runs/${runId}/spans/${spanId}`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    ...
    createBulkAction(options, requestOptions) {
        return zodfetch(CreateBulkActionResponseBody, `${this.baseUrl}/api/v1/bulk-actions`, {
            method: "POST",
            headers: this.#getHeaders(false),
    ...
    listBulkActions(query, requestOptions) {
        return zodfetchCursorPage(BulkActionObject, `${this.baseUrl}/api/v1/bulk-actions`, {
    ...
    retrieveBulkAction(bulkActionId, requestOptions) {
        return zodfetch(BulkActionObject, `${this.baseUrl}/api/v1/bulk-actions/${bulkActionId}`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    abortBulkAction(bulkActionId, requestOptions) {
        return zodfetch(AbortBulkActionResponseBody, `${this.baseUrl}/api/v1/bulk-actions/${bulkActionId}/abort`, {
            method: "POST",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    ...
    createSession(body, requestOptions) {
        return zodfetch(CreatedSessionResponseBody, `${this.baseUrl}/api/v1/sessions`, {
            method: "POST",
            headers: this.#getHeaders(false),
            body: JSON.stringify(body),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    ...
    retrieveSession(sessionIdOrExternalId, requestOptions) {
        return zodfetch(RetrieveSessionResponseBody, `${this.baseUrl}/api/v1/sessions/${encodeURIComponent(sessionIdOrExternalId)}`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    ...
    closeSession(sessionIdOrExternalId, body, requestOptions) {
        return zodfetch(RetrieveSessionResponseBody, `${this.baseUrl}/api/v1/sessions/${encodeURIComponent(sessionIdOrExternalId)}/close`, {
            method: "POST",
            headers: this.#getHeaders(false),
            body: JSON.stringify(body ?? {}),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    ...
    endAndContinueSession(sessionIdOrExternalId, body, requestOptions) {
        return zodfetch(EndAndContinueSessionResponseBody, `${this.baseUrl}/api/v1/sessions/${encodeURIComponent(sessionIdOrExternalId)}/end-and-continue`, {
            method: "POST",
            headers: this.#getHeaders(false),
            body: JSON.stringify(body),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    ...
    listSessions(options, requestOptions) {
        ...
        return zodfetchCursorPage(ListedSessionItem, `${this.baseUrl}/api/v1/sessions`, {
            query: searchParams,
            limit: options?.limit,
            after: options?.after,
    ...
    async initializeSessionStream(sessionIdOrExternalId, io, requestOptions) {
        ...
        // `StreamsWriterV2`.
        return zodfetch(CreateStreamResponseBody, `${this.baseUrl}/realtime/v1/sessions/${encodeURIComponent(sessionIdOrExternalId)}/${io}`, {
            method: "PUT",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions))
            .withResponse()
    ...
    async appendToSessionStream(sessionIdOrExternalId, io, part, requestOptions) {
        ...
        const partId = nanoid();
        return zodfetch(AppendToStreamResponseBody, `${this.baseUrl}/realtime/v1/sessions/${encodeURIComponent(sessionIdOrExternalId)}/${io}/append`, {
            method: "POST",
    ...
    async readSessionStreamRecords(sessionIdOrExternalId, io, options) {
        ...
        return zodfetch(ReadSessionStreamRecordsResponseBody, url, {
            method: "GET",
            headers: this.#getHeaders(false),
    ...
    retrieveCurrentDeployment(requestOptions) {
        return zodfetch(RetrieveCurrentDeploymentResponseBody, `${this.baseUrl}/api/v1/deployments/current`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    ...
    async createSessionStreamWaitpoint(runFriendlyId, body, requestOptions) {
        return zodfetch(CreateSessionStreamWaitpointResponseBody, `${this.baseUrl}/api/v1/runs/${runFriendlyId}/session-streams/wait`, {
            method: "POST",
            headers: this.#getHeaders(false),
            body: JSON.stringify(body),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    ...
    async getQuerySchema(requestOptions) {
        return zodfetch(QuerySchemaResponseBody, `${this.baseUrl}/api/v1/query/schema`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    async listDashboards(requestOptions) {
        return zodfetch(ListDashboardsResponseBody, `${this.baseUrl}/api/v1/query/dashboards`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    ...
    resolvePrompt(slug, body, requestOptions) {
        return zodfetch(ResolvePromptResponseBody, `${this.baseUrl}/api/v1/prompts/${slug}`, {
            method: "POST",
            headers: this.#getHeaders(false),
            body: JSON.stringify(body),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    ...
    listPrompts(requestOptions) {
        return zodfetch(ListPromptsResponseBody, `${this.baseUrl}/api/v1/prompts`, { method: "GET", headers: this.#getHeaders(false) }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    listPromptVersions(slug, requestOptions) {
        return zodfetch(ListPromptVersionsResponseBody, `${this.baseUrl}/api/v1/prompts/${slug}/versions`, { method: "GET", headers: this.#getHeaders(false) }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    promotePromptVersion(slug, body, requestOptions) {
        return zodfetch(PromptOkResponseBody, `${this.baseUrl}/api/v1/prompts/${slug}/promote`, { method: "POST", headers: this.#getHeaders(false), body: JSON.stringify(body) }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    createPromptOverride(slug, body, requestOptions) {
        return zodfetch(PromptOverrideCreatedResponseBody, `${this.baseUrl}/api/v1/prompts/${slug}/override`, { method: "POST", headers: this.#getHeaders(false), body: JSON.stringify(body) }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    updatePromptOverride(slug, body, requestOptions) {
        return zodfetch(PromptOkResponseBody, `${this.baseUrl}/api/v1/prompts/${slug}/override`, { method: "PUT", headers: this.#getHeaders(false), body: JSON.stringify(body) }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    removePromptOverride(slug, requestOptions) {
        return zodfetch(PromptOkResponseBody, `${this.baseUrl}/api/v1/prompts/${slug}/override`, { method: "DELETE", headers: this.#getHeaders(false) }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    reactivatePromptOverride(slug, body, requestOptions) {
        return zodfetch(PromptOkResponseBody, `${this.baseUrl}/api/v1/prompts/${slug}/override/reactivate`, { method: "POST", headers: this.#getHeaders(false), body: JSON.stringify(body) }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
    #getRealtimeHeaders() {
        let headers = {
            Authorization: `Bearer ${this.accessToken}`,
