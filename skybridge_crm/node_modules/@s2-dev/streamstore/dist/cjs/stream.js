    ...
    async read(input, options) {
        ...
        return await (0, retry_js_1.withRetries)(this.retryConfig, async () => {
            ...
            while (true) {
                ...
                const readArgs = {
                    ...(0, mappers_js_1.toAPIReadQuery)(currentInput),
                    as,
                ...
                const filtered = batch.records.filter((r) => !(0, utils_js_1.isCommandRecord)(r));
