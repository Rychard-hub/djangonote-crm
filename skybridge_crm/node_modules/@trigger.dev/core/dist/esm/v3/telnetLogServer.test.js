...
describe("formatConsoleLine", () => {
    test("pretty-formats a JSON structured-log line", () => {
        ...
        expect(formatConsoleLine(raw)).toBe("2026-06-11T12:00:00.000Z INFO  [sso-plugin] sso.webhook.connection.activated: connection marked active {connId=conn_123}");
    });
