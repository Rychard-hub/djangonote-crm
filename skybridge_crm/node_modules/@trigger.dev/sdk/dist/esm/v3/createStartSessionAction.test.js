...
import { __setSessionStartImplForTests, __setSessionOpenImplForTests, SessionHandle, } from "./sessions.js";
...
function installStartFixture() {
    __setSessionStartImplForTests(async (body) => {
        lastStartBody = body;
        return {
            id: "session_fixture",
