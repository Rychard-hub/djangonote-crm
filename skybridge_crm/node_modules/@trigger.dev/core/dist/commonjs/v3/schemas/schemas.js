...
const AgentConfig = zod_1.z.object({
    type: zod_1.z.string(),
});
const taskMetadata = {
    id: zod_1.z.string(),
...
exports.SkillMetadata = zod_1.z.object(skillMetadata);
exports.SkillManifest = zod_1.z.object({
    ...skillMetadata,
    ...taskFileMetadata,
});
