...
export declare class ExternalSpanExporterWrapper {
    ...
    private externalTraceId;
    constructor(underlyingExporter: SpanExporter, externalTraceId: string);
