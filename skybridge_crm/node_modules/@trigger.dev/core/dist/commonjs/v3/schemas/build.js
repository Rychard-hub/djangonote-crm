...
exports.ConfigRuntime = zod_1.z.enum([
    "node",
    "node-22",
...
exports.BuildRuntime = zod_1.z.enum(["node", "node-22", "node-24", "node-26", "bun"]);
exports.BuildManifest = zod_1.z.object({
    ...
    deploy: zod_1.z.object({
        ...
        sync: zod_1.z
            ...
            secretEnv: zod_1.z.record(zod_1.z.string()).optional(),
            secretParentEnv: zod_1.z.record(zod_1.z.string()).optional(),
        })
            .optional(),
    }),
    image: zod_1.z
