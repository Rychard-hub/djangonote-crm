import { type AsyncIterableStream, type WriterStreamOptions, type PipeStreamOptions, type PipeStreamResult, type ReadStreamOptions, type AppendStreamOptions, type RealtimeDefinedStream, type InferStreamType, type RealtimeDefinedInputStream, type InferInputStreamType } from "@trigger.dev/core/v3";
/**
 ...
 * ```
 */
declare function input<TData>(opts: {
    id: string;
}): RealtimeDefinedInputStream<TData>;
